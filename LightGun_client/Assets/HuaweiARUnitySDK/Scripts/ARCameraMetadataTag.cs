...
namespace HuaweiARUnitySDK
{
    /**
     * \if english
     * @brief This enum follows the layout of NdkCameraMetadataTags.
     *
     * The values in the file are used for requesting / marshaling camera image's metadata. The comments
     * have been removed to keep the code readable. Please refer to
     * <a href="https://developer.android.com/ndk/reference/ndk_camera_metadata_tags_8h.html" >NdkCameraMetadataTags.h </a>.
     * \else
     * @brief NdkCameraMetadataTags的枚举值。
     *
     * 用于请求相机的元数据。具体值的含义请参考
     * <a href="https://developer.android.com/ndk/reference/ndk_camera_metadata_tags_8h.html" >NdkCameraMetadataTags.h </a>
     * \endif
     */
