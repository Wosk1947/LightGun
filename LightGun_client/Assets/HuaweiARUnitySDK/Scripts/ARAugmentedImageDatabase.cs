...
namespace HuaweiARUnitySDK
{
    ...
    /**
     * \if english
     * @brief A database storing a list of images to be detected and tracked by devices.
     * Only one image database can be in use at any given time.
     *
     * \else
     * @brief 包含一系列用于识别和跟踪的Image图像的数据库，任何时候只能使用1个数据库。
     *
     * \endif
     */
    public class ARAugmentedImageDatabase : ScriptableObject
    {
        ...
        /**
         * \if english
         * @brief Gets the number of images in the database.
         *
         * \else
         * @brief 获取数据库中图片的数目.
         *
        ...
        /**
         * \if english
         * @brief Gets or sets the image at the specified index.
         * You can only modify the database in the Unity editor.
         *
         * \else
         * @brief 获取或设置数据库中指定Index的图片记录
         *
         * \endif
         */
        ...
        /**
         * \if english
         * @brief  Adds an image to this database.
         *
         * \else
         * @brief 向数据库中增加图片记录
         *
        ...
        /**
         * \if english
         * @brief  Remove the image at the specified index from this database.
         *
         * \else
         * @brief 删除数据库中指定index的图片记录
         *
         * \endif
         */
